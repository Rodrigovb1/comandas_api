...
class AuditoriaCreate(BaseModel):
    ...
    funcionario_id: int
    acao: str = Field(..., max_length=50, description="Tipo de ação, ex: LOGIN, LOGOUT, CREATE, UPDATE, DELETE, CANCEL, etc")
    recurso: str = Field(..., max_length=100, description="Recurso acessado, ex: comandas, recebimento, produto, etc")
